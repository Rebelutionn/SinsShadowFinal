...
if objPlayerGrapple.bGrappling
{
	...
	{
		bGPDrawDoOnce = true;
		ropeSeg2 = physics_joint_rope_create(self, objPlayerGrapple.instNearestGP, x, y, objPlayerGrapple.instNearestGP.x, objPlayerGrapple.instNearestGP.y, objPlayerGrapple.distNearestGP/2, false);
		physics_joint_set_value(ropeSeg2, 120, objPlayerGrapple.distNearestGP/2);
		...
		physics_joint_set_value(ropeSeg1, 120, objPlayerGrapple.distNearestGP/2);
	}
}
if !objPlayerGrapple.bGrappling
{
